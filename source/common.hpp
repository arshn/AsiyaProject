...
//! EXPORTS & EXTRA
#if defined(__WINNT) || defined(__WINNT__) || defined(WIN32) || defined(_WIN32) || defined(__WIN32) || defined(__WIN32__) ||        defined(WIN64) || defined(_WIN64) || defined(__WIN64) ||        defined(__WIN64__)
//! Microsoft Windows
...
#define __project_export_pointer(Class, object)__project_extern_c __project_export Class* object = __project_nullptr;

#define PROJECT_DEFAULT_OCTORS_WITHOUT_IMPL(Class)     Class() = default;    ~Class() = default;

#define PROJECT_DEFAULT_INTERFACE_OCTORS_WITHOUT_IMPL(Class) Class() = default;    virtual ~Class() = default;

#define PROJECT_DEFAULT_OCTORS(Class) Class();    ~Class();

#define PROJECT_DEFAULT_OCTORS_IMPL(Class)Class::Class(){}    Class::~Class(){}
#define PROJECT_DEFAULT_INTERFACE_OCTORS(Class) Class();    virtual ~Class();

#define PROJECT_DEFAULT_INTERFACE_OCTORS_IMPL(Class)Class::Class() {}    Class::~Class(){}
/*!
...
#define PROJECT_DISABLE_COPY(Class)     Class(const Class &) = delete;    Class &operator=(const Class &) = delete;

//!Macro version of non-movable.

#define PROJECT_DISABLE_MOVE(Class)     Class(Class &&) = delete;     Class &operator=(Class &&) = delete;

//!Macro version of non-copyable and non-movable.
#define PROJECT_DISABLE_COPY_MOVE(Class)     PROJECT_DISABLE_COPY(Class)     PROJECT_DISABLE_MOVE(Class)
